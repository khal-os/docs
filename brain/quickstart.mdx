...
```text
TASK: Use the Khal OS docs page `brain/quickstart.mdx` (Quickstart) to guide an FDE through the workflow, run only safe verification commands first, and return evidence with blockers.
