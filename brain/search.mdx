---
title: "Search"
description: "BM25, vector, and hybrid search strategies with confidence scoring"
icon: "magnifying-glass"
---

Brain combines traditional full-text search with vector similarity to deliver high-precision results. Every result carries a confidence score — Brain prefers fewer strong hits over many noisy ones.
