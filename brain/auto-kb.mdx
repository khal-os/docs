...
```text
TASK: Use the Khal OS docs page `brain/auto-kb.mdx` (Closed-loop intelligence) to guide an FDE through the workflow, run only safe verification commands first, and return evidence with blockers.
