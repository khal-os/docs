...
```text
TASK: Use the Khal OS docs page `brain/knowledge-graph.mdx` (Knowledge graph operations) to guide an FDE through the workflow, run only safe verification commands first, and return evidence with blockers.
