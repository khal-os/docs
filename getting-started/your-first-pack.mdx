...
<Tabs>
  ...
  <Tab title="Hosted instance">
    Publish to GitHub Packages (push your branch — CI handles the rest) and install the resulting `@next` tag into your hosted KhalOS instance. This is the full production path.
  </Tab>
</Tabs>
