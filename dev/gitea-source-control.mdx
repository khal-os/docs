...
```text
TASK: Use the Khal OS docs page `dev/gitea-source-control.mdx` (Source control for KHAL teams) to guide an FDE through the workflow, run only safe verification commands first, and return evidence with blockers.
