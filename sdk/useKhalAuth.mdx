...
<CardGroup cols={2}>
  <Card title="useNats" icon="satellite-dish" href="/sdk/useNats">
...
```text
TASK: Use the Khal OS docs page `sdk/useKhalAuth.mdx` (useKhalAuth) to guide an FDE through the workflow, run only safe verification commands first, and return evidence with blockers.
