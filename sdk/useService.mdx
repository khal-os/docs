...
```text
TASK: Use the Khal OS docs page `sdk/useService.mdx` (useService) to guide an FDE through the workflow, run only safe verification commands first, and return evidence with blockers.
