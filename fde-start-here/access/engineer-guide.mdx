...
- The `khal` CLI — see [Install your FDE toolchain](/fde-start-here/install-toolchain).
...
<CardGroup cols={2}>
  ...
  <Card title="Day 0 walkthrough" icon="route" href="/fde-start-here/day-zero-walkthrough">
