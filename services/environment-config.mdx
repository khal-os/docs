...
```text
TASK: Use the Khal OS docs page `services/environment-config.mdx` (Environment + config) to guide an FDE through the workflow, run only safe verification commands first, and return evidence with blockers.
